...
CREATE TABLE `manager` (
  ...
  CONSTRAINT `manager_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `department` (`dept_id`)
...
INSERT INTO `manager` VALUES (2001,1001,'Sam','White'),(2002,1002,'Anne','Lee'),(2003,1003,'Rick','Roll'),(2004,1004,'Richard','Daley'),(2005,1005,'Mitch','Hell');
